...
Variables track the flow of grain C and N to food and of all other plant pools, including live stem C and N, to litter, and to biofuel.
...
(Equation :eq:`25.9`, Equation :eq:`25.10`, Equation :eq:`25.12`, and Equation :eq:`25.13`),
with the remaining portions go the litter pools (Equation :eq:`20.14)`, Equation :eq:`25.11`, and Equation :eq:`25.14`).
...
are routed to the litter pools in the same manner as natural vegetation.
...
where :math:`biofuel\_harvfrac` is the harvested fraction of leaf/livestem for biofuels.

.. _Table Plant functional type (PFT) parameters for harvested fraction of leaf/livestem for biofuels:

.. table:: Plant functional type (PFT) parameters for harvested fraction of leaf/livestem for biofuels.
